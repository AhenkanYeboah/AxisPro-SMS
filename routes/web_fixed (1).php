...
Route::middleware(['web', ResolveTenant::class])->group(function () {
    Route::scopeBindings()->group(function () {
        ...
        // FIX: original method showRegister doesn't exist - try showRegistrationForm, fallback to create
        Route::get('/student/register', [StudentAuthController::class, 'showRegistrationForm'])->name('student.form');
