    ...
    Route::scopeBindings()->group(function () {
        ...
        Route::middleware('auth:student')->group(function () {
            ...
            Route::middleware('admitted')->group(function () {
                ...
                Route::get('/student/library', [StudentLibraryController::class, 'index'])->name('student.library');
                Route::get('/student/library/{material}/read', [StudentLibraryController::class, 'read'])->name('student.library.read');
                Route::get('/student/library/{material}/stream', [StudentLibraryController::class, 'stream'])->name('student.library.stream');
                Route::get('/student/library/{material}/download', [StudentLibraryController::class, 'download'])->name('student.library.download');
        ...
        Route::middleware('auth:teacher')->group(function () {
            ...
            Route::get('/teacher/library', [TeacherLibraryController::class, 'index'])->name('teacher.library');
            Route::post('/teacher/library', [TeacherLibraryController::class, 'store'])->name('teacher.library.store');
            Route::delete('/teacher/library/{material}', [TeacherLibraryController::class, 'destroy'])->name('teacher.library.destroy');
