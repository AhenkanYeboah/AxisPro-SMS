...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('salary_structures', function (Blueprint $table) {
            ...
            $table->bigInteger('basic_pesewas'); // GHS * 100
            $table->json('allowances_json')->nullable(); // [{name, amount_pesewas}]
        ...
        // 3. PAYE brackets (global + per-school override)
        Schema::create('paye_tax_brackets', function (Blueprint $table) {
            $table->id();
            $table->foreignId('school_id')->nullable()->constrained()->nullOnDelete(); // null = global
